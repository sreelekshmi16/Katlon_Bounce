...
Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Search country (1)'), 'India')

Mobile.tap(findTestObject('Object Repository/android.view.ViewGroup (2)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Enter your mobile number (2)'), '1234567788')
