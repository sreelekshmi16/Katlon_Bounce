...
public class Test1 {
	...
	public String getOTP(String countryName, String number) {
		...
		try {
			...
			println ("country code and number": number +" "+countryCode)
			...
			println("Json: "+POST_PARAMS)
			
			URL obj = new URL("https://uat.sso-api.hellobounce.com/v1/sso/otp-list?offset=0&limit=10&startDate=&endDate=&status=&phoneCode=&phoneNumber=&email=");
...
//https://uat.sso-api.hellobounce.com/
			//get otp using authorization token
			URL urlForGetRequest = new URL("https://uat.sso-api.hellobounce.com/v1/sso/otp-list?offset=0&limit=10&startDate=&endDate=&status=&phoneCode="+countryCode+"&phoneNumber="+number);
	...
	public void otp(String cName, String number) {
		...
		char[] otp = (new utilities.Test1().getOTP("India", "1234567788").toCharArray())
